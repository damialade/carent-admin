...
const PaymentModal = ({ onClose = () => {}, show, onClick }) => {
  return (
    <>
            ...
            <div className="flex items-center justify-center min-h-full p-4 text-center">
              ...
              >
                <DialogPanel className="w-full max-w-md p-6 overflow-hidden text-left align-middle transition-all transform bg-app-darkGray shadow-xl rounded-2xl">
                  ...
                  <div className="flex space-x-3 items-center text-red-600 font-medium">
                    <p>Total Due:</p>
                    <p>₦40,000</p>
                  </div>
                  ...
                  <form>
                    ...
                    <div className=" px-8">
                      <div className=" w-full flex items-center space-x-7 my-2 py-2 ">
                        <select className="w-[50%] h-fit px-3 py-2 leading-tight text-app-white placeholder-white rounded shadow-lg bg-app-grey  focus:outline-none focus:shadow-outline">
                          <option
                            value=""
